...
<html>
  ...
  ol(ordered list): 순서목록 type="숫자(기본) | 로마대소문자 |알파벳소문자 "
  </pre>
  <hr/><!-- 수평선. 구분역할 -->
  <ul>
    <li>ul(unordered list): 무순서목록</li>
  	<li type="circle">프론트엔드 - HTML, CSS, JavaScript,jQuery,Ajax,JSON 등</li>
  	<li type="square">백엔드 - Java, JSP/Servlet 등</li>
    <li type="disc">DBMS - 오라클, MySQL,MariaDB 등</li>
  </ul>	
  <ol>
  ...
  <hr/>	 
		...
		HTML : Hyper Text Markup Lanaguage.
					   웹문서골격.내용
		<p>XML : eXtensible Markup Lanaguage.</p>
		            확장가능한 마크업언어.
		            데이터.(작은db역할)
		            다른 언어들과 연동.
		            주로 환경설정용으로 사용.			   
